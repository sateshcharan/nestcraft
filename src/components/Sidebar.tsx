...
export function Sidebar({ title, description, children, className }: props) {
  ...
  return (
    <ScrollArea className="min-h-screen overflow-y-auto scrollbar-thin scrollbar-thumb-rounded scrollbar-thumb-gray-700 scrollbar-track-transparent p-4 bg-slate-100">
      <header>
        <title>
